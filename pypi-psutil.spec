...
Source0  : https://files.pythonhosted.org/packages/26/10/2a30b13c61e7cf937f4adf90710776b7918ed0a9c434e2c38224732af310/psutil-6.1.0.tar.gz
...
%prep
%setup -q -n psutil-6.1.0
cd %{_builddir}/psutil-6.1.0
pushd ..
cp -a psutil-6.1.0 buildavx2
popd
pushd ..
cp -a psutil-6.1.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1729261292
