...
Source0  : https://files.pythonhosted.org/packages/1f/5a/07871137bb752428aa4b659f910b399ba6f291156bdea939be3e96cae7cb/psutil-6.1.1.tar.gz
...
%prep
%setup -q -n psutil-6.1.1
cd %{_builddir}/psutil-6.1.1
pushd ..
cp -a psutil-6.1.1 buildavx2
popd
pushd ..
cp -a psutil-6.1.1 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735098184
