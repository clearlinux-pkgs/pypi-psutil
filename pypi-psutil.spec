...
Source0  : https://files.pythonhosted.org/packages/18/c7/8c6872f7372eb6a6b2e4708b88419fb46b857f7a2e1892966b851cc79fc9/psutil-6.0.0.tar.gz
...
%prep
%setup -q -n psutil-6.0.0
cd %{_builddir}/psutil-6.0.0
pushd ..
cp -a psutil-6.0.0 buildavx2
popd
pushd ..
cp -a psutil-6.0.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718822649
