...
Source0  : https://files.pythonhosted.org/packages/90/c7/6dc0a455d111f68ee43f27793971cf03fe29b6ef972042549db29eec39a2/psutil-5.9.8.tar.gz
...
%prep
%setup -q -n psutil-5.9.8
cd %{_builddir}/psutil-5.9.8
pushd ..
cp -a psutil-5.9.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705865958
